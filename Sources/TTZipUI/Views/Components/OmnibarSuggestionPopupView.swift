...
public struct OmnibarSuggestionPopupView: View {
    public let suggestions: [AddressBarSuggestionItem]
    public let selectedIndex: Int?
    public let onSelectSuggestion: (AddressBarSuggestionItem) -> Void
    
    @State private var hoveredID: String? = nil
    
    public init(
        suggestions: [AddressBarSuggestionItem],
        selectedIndex: Int?,
        onSelectSuggestion: @escaping (AddressBarSuggestionItem) -> Void
    ) {
