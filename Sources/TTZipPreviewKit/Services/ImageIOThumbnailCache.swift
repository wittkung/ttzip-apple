...
public actor ImageIOThumbnailCache {
    ...
    public nonisolated func downsample(url: URL, maxPixelSize: CGFloat = 2048) -> NSImage? {
    ...
    public nonisolated func downsample(data: Data, maxPixelSize: CGFloat = 2048) -> NSImage? {
